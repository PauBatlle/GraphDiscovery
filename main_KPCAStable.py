...
# kpca.build_graph(X, ks, gamma=1e-13, beta1=1, beta2=0, beta3=0, epsilon=1e-3, tau1=0.5, tau2=0.5, noise_scale=1e-1, nugget=1e-12, names=['x1', 'x2', 'x3', 'x4'], verbose=True, plot=True)
# plt.show()
